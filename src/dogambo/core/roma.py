#!/usr/bin/python3
"""
Robust model adaptation (RoMA) offline objective transform implementation.

Author(s):
    Michael Yao @michael-s-yao

Citation(s):
    [1] Yu S, Ahn S, Song L, Shin J. RoMA: Robust model adaptation for
        offline model-based optimization. Proc NeurIPS. (2021). URL:
...
class RoMATransform(BaseObjectiveTransform):
    name: Final[str] = "RoMATransform"
